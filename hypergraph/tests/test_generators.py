...
def test_impossible_number_of_edges_in_uniform_generator():
    number_of_nodes = 5
    number_of_edges = 5
    cardinality = 5

    nt.assert_raises(ValueError, generators.uniform_hypergraph, number_of_nodes, number_of_edges, cardinality)
